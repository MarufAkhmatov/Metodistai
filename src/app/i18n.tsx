...
const uz: Translations = {
  ...
  // header (top bar)
  'header.now': 'Faol',
  'header.activeSecondsAgo': '{s} soniya oldin',
  'header.activeMinutesAgo': '{m} daqiqa oldin',
  'header.activeHoursAgo': '{h} soat oldin',
  'header.lastActive': 'Faol holat',
  'header.today': 'Bugun',
  'header.timeNow': 'Hozir',
  'header.kbBadge': '{count} papka — Bilim bazasi',
  'header.kbBadgeLoading': 'Bilim bazasi yuklanmoqda…',
  'header.refresh': 'Yangilash',
  'header.refreshTitle': 'Papkalar va arxivni qayta yuklash',
  'header.fsEnter': 'Butun ekran',
  'header.fsExit': 'Ekrandan chiqish',
  'header.viewport': "Ko'rinish",
  'header.desktop': 'Desktop',
  'header.mobile': 'Mobile',
  'header.mobilePreviewTitle': "Mobil ko'rinish yangi oynada ochiladi (390×844)",
  'header.createFolders': 'Papka yaratish',
  'header.addFiles': "Fayl qo'shish",
};
...
const ru: Translations = {
  ...
  // header (top bar)
  'header.now': 'Активен',
  'header.activeSecondsAgo': '{s} с назад',
  'header.activeMinutesAgo': '{m} мин назад',
  'header.activeHoursAgo': '{h} ч назад',
  'header.lastActive': 'Последняя активность',
  'header.today': 'Сегодня',
  'header.timeNow': 'Сейчас',
  'header.kbBadge': 'папок — База знаний: {count}',
  'header.kbBadgeLoading': 'Загрузка базы знаний…',
  'header.refresh': 'Обновить',
  'header.refreshTitle': 'Перезагрузить папки и архив',
  'header.fsEnter': 'Полный экран',
  'header.fsExit': 'Выйти из полного экрана',
  'header.viewport': 'Вид',
  'header.desktop': 'Desktop',
  'header.mobile': 'Mobile',
  'header.mobilePreviewTitle': 'Открыть мобильный вид в новом окне (390×844)',
  'header.createFolders': 'Создать папку',
  'header.addFiles': 'Добавить файл',
};
...
const en: Translations = {
  ...
  // header (top bar)
  'header.now': 'Active',
  'header.activeSecondsAgo': '{s}s ago',
  'header.activeMinutesAgo': '{m}m ago',
  'header.activeHoursAgo': '{h}h ago',
  'header.lastActive': 'Last active',
  'header.today': 'Today',
  'header.timeNow': 'Now',
  'header.kbBadge': '{count} folders — Knowledge Base',
  'header.kbBadgeLoading': 'Loading Knowledge Base…',
  'header.refresh': 'Refresh',
  'header.refreshTitle': 'Refresh folders & archive',
  'header.fsEnter': 'Fullscreen',
  'header.fsExit': 'Exit fullscreen',
  'header.viewport': 'View',
  'header.desktop': 'Desktop',
  'header.mobile': 'Mobile',
  'header.mobilePreviewTitle': 'Open mobile preview in a new window (390×844)',
  'header.createFolders': 'Create folders',
  'header.addFiles': 'Add files',
};
